 ...
 * @author dosen
 */
public class DlgPermintaanRanap2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPermintaanRanap2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPermintaanRanap2 dialog = new DlgPermintaanRanap2(new javax.swing.JFrame(), true);
