...
public class RMRiwayatLab extends javax.swing.JDialog {
    ...
    private String norm="",nip="",file="";
    private StringBuilder htmlContent;
    
    /** Creates new form DlgProgramStudi
     * @param parent
     * @param modal */
    public RMRiwayatLab(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Lab Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            File f = new File("RiwayatRadiologi.html");            
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMRiwayatLab dialog = new RMRiwayatLab(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='69%'>Pemeriksaan</td>"+
                "</tr>"
            );
                    ...
                    if (rs4.next()) {
                        htmlContent.append(  
                          "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>").append(
                            "<tr><td valign='top' colspan='4'>Pemeriksaan Laboratorium PK & MB</td><td valign='top' colspan='1' align='right'>:</td><td valign='top'></td></tr>").append(            
                        ...
                        while (rs4.next()) {
                            try {
                                ...
                                while (rs2.next()) {
                                    ...
                                    // biayaperawatan += rs2.getDouble("biaya"); // commented out
                                            ...
                                            do {
                                                htmlContent.append(
                                                    "<tr>").append(
                                                       ...
                                                       "<td valign='top'>").append(rs3.getString("nilai")).append(" ").append(rs3.getString("satuan")).append("</td>").append(
                                                       "<td valign='top'>").append(rs3.getString("nilai_rujukan")).append("</td>").append(
                                                    "</tr>"); 

                                                // biayaperawatan += rs3.getDouble("biaya_item"); // commented out
                                            } while (rs3.next());                              
                                        }
                                    } catch (Exception e) {
                                        System.out.println("Notifikasi : " + e);
                                    ...
                                    if (rs3.next()) {      
                                        htmlContent.append(
                                                ...
                                                "<tr>").append(
                                                   ...
                                                   "<td valign='top' colspan='4'>: ").append(rs3.getString("saran")).append("</td>").append(
                                                "</tr>");
                                    } 
                                } catch (Exception e) {
...
//               PA
                        try{
                            ...
                            if(rs2.next()){
                                htmlContent.append(  
                                  "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>").append(
                                    "<tr><td valign='top' colspan='4'>Pemeriksaan Laboratorium PA</td><td valign='top' colspan='1' align='right'>:</td><td valign='top'></td></tr>").append(            
                                    "<tr align='center'>").append(
                                      "<td valign='top' width='4%' bgcolor='#FFFAF8'>No.</td>").append(
                                      "<td valign='top' width='15%' bgcolor='#FFFAF8'>Tanggal</td>").append(
                                      "<td valign='top' width='10%' bgcolor='#FFFAF8'>Kode</td>").append(
