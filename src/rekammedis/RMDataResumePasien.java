...
public final class RMDataResumePasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnEdukasi = new javax.swing.JButton();
        ...
        BtnEdukasi.setBounds(790, 590, 70, 23);
    ...
    private void BtnEdukasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdukasiActionPerformed
        ...
        if (!Obat2an.getText().trim().isEmpty()) {
            Obat2an.append("\n\n" + edukasi);
        } else {
            Obat2an.setText(edukasi);
        }
    ...
    private javax.swing.JButton BtnEdukasi;
