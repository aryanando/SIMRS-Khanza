...
public final class ValidasiTBAKRalan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi TBAK Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_ralan_tbak","?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",12,new String[]{
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "on pemeriksaan_ralan_tbak.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ralan_tbak.nip=pegawai.nik LEFT JOIN validasi_pemeriksaan_ralan_tbak ON validasi_pemeriksaan_ralan_tbak.no_rawat = pemeriksaan_ralan_tbak.no_rawat AND validasi_pemeriksaan_ralan_tbak.tgl_perawatan = pemeriksaan_ralan_tbak.tgl_perawatan AND validasi_pemeriksaan_ralan_tbak.jam_rawat = pemeriksaan_ralan_tbak.jam_rawat where "+
                    "pemeriksaan_ralan_tbak.no_rawat like ? and ISNULL(validasi_pemeriksaan_ralan_tbak.status_validasi) order by pemeriksaan_ralan_tbak.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan_tbak.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan_tbak.tgl_perawatan,pemeriksaan_ralan_tbak.jam_rawat,pemeriksaan_ralan_tbak.situation, " +
