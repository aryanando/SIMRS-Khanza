...
public class DlgTBAKRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTBAKRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ TBAK Perawatan Ralan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTBAKRalan dialog = new DlgTBAKRalan(new javax.swing.JFrame(), true);
...
//                }
            ps = koneksi.prepareStatement(
                ...
                "INNER JOIN pemeriksaan_ralan_tbak AS sbar ON sbar.no_rawat = reg_periksa.no_rawat " +
...
//                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2=koneksi.prepareStatement(
                                ...
                                "validasi_pemeriksaan_ralan_tbak.nik_validator,namavalidator.nama as namavalidator,validasi_pemeriksaan_ralan_tbak.tgl_validasi,validasi_pemeriksaan_ralan_tbak.jam_validasi,validasi_pemeriksaan_ralan_tbak.status_validasi "+ 
                                "from pemeriksaan_ralan_tbak LEFT JOIN validasi_pemeriksaan_ralan_tbak ON validasi_pemeriksaan_ralan_tbak.no_rawat = pemeriksaan_ralan_tbak.no_rawat AND validasi_pemeriksaan_ralan_tbak.tgl_perawatan = pemeriksaan_ralan_tbak.tgl_perawatan AND validasi_pemeriksaan_ralan_tbak.jam_rawat = pemeriksaan_ralan_tbak.jam_rawat inner join pegawai on pemeriksaan_ralan_tbak.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_ralan_tbak.nik_validator=namavalidator.nik where pemeriksaan_ralan_tbak.no_rawat='"+rs.getString("no_rawat")+"' "+
                        ...
                        if(rs2.next()){
                            ...
                            while(rs2.next()){
                                ...
                                if(Sequel.cariInteger("select count(validasi_pemeriksaan_ralan_tbak.nik_validator) " +
                                        "from pemeriksaan_ralan_tbak LEFT JOIN validasi_pemeriksaan_ralan_tbak ON validasi_pemeriksaan_ralan_tbak.no_rawat = pemeriksaan_ralan_tbak.no_rawat AND validasi_pemeriksaan_ralan_tbak.tgl_perawatan = pemeriksaan_ralan_tbak.tgl_perawatan AND validasi_pemeriksaan_ralan_tbak.jam_rawat = pemeriksaan_ralan_tbak.jam_rawat inner join pegawai on pemeriksaan_ralan_tbak.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_ralan_tbak.nik_validator=namavalidator.nik where pemeriksaan_ralan_tbak.no_rawat='"+rs.getString("no_rawat")+"' AND validasi_pemeriksaan_ralan_tbak.nik_validator='"+rs2.getString("nik_validator")+"'" +
