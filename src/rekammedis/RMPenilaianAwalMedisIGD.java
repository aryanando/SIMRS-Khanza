...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnCopyClip = new javax.swing.JButton();
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-02-2026 10:00:19" }));
        ...
        BtnCopyClip.setText("Copy Clip");
        BtnCopyClip.setName("BtnCopyClip"); // NOI18N
        BtnCopyClip.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCopyClipActionPerformed(evt);
            }
        });
        FormInput.add(BtnCopyClip);
        BtnCopyClip.setBounds(860, 90, 90, 23);
    ...
    private void BtnCopyClipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCopyClipActionPerformed
//        Clipboard clip = getToolkit().getSystemClipboard();
        String formattedText
                ...
                + "Pl tx : \n"
                + Tatalaksana.getText() + "\n\n\n"
                + "Berikut terlampir hasil pemeriksaan penunjang dokter,\n"
        ...
        JOptionPane.showMessageDialog(null, "SOAP berhasil dicopy ke clipboard!");
    }//GEN-LAST:event_BtnCopyClipActionPerformed
    ...
    private javax.swing.JButton BtnCopyClip;
