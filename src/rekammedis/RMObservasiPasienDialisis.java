...
public final class RMObservasiPasienDialisis extends javax.swing.JDialog {
    ...
    private String finger = "", kamar = "", namakamar = "", status = "", norawatibu = "", kelas = "", posisi = "", namaDr = "", namaPt = "", finger2 = "";
...
//            Valid.pindah(evt,Tindakan,BtnBatal);
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            namaDr = Sequel.cariIsi("select nama from pegawai where pegawai.nik=?", tbObat.getValueAt(tbObat.getSelectedRow(), 6).toString());
    ...
    private void BtnHapusRiwayatPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusRiwayatPersalinanActionPerformed
        if (tbRiwayatEdukasi.getSelectedRow() > -1) {
            Sequel.meghapus("catatan_observasi_dialisis", "no_rawat", "jam", TNoRw.getText(), tbRiwayatEdukasi.getValueAt(tbRiwayatEdukasi.getSelectedRow(), 0).toString());
            tampilEdukasi();
