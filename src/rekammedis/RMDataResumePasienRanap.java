...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private String kodekamar = "", namakamar = "", tglkeluar = "", jamkeluar = "", finger = "", json, bangsal = "";
    ...
    private void initComponents() {
        ...
        BtnDokter19.setBounds(70, 1140, 28, 23);
        ...
        BtnDokter21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/obat_pulang.png")));
        BtnDokter21.setMnemonic('2');
        BtnDokter21.setText("Input Obat Pulang");
        BtnDokter21.setToolTipText("Alt+2");
        BtnDokter21.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnDokter22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/obat_pulang.png")));
        BtnDokter22.setMnemonic('2');
        BtnDokter22.setText("Input Obat Pulang");
        BtnDokter22.setToolTipText("Alt+2");
        BtnDokter22.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnDokter22.setBounds(790, 1000, 140, 23);
    ...
    boolean tidakValid(String text) {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().equals("") || TNoRM.getText().equals("") || TPasien.getText().equals("")) {
            ...
            String textObat = ObatSelamaDiRS.getText();

            String prosedurUtama = ProsedurUtama.getText();
            String prosedur1 = ProsedurSekunder1.getText();
            String prosedur2 = ProsedurSekunder2.getText();
            String prosedur3 = ProsedurSekunder3.getText();

            if (textObat == null || textObat.trim().length() < 50) {
                JOptionPane.showMessageDialog(null, "Obat Selama Di RS minimal 50 karakter!");

            } else if (tidakValid(prosedurUtama)) {
                JOptionPane.showMessageDialog(null, "Prosedur Utama tidak boleh kosong atau '-'!");

            } else if (tidakValid(prosedur1)) {
                JOptionPane.showMessageDialog(null, "Prosedur Sekunder 1 tidak boleh kosong atau '-'!");

            } else if (tidakValid(prosedur2)) {
                JOptionPane.showMessageDialog(null, "Prosedur Sekunder 2 tidak boleh kosong atau '-'!");

            } else if (tidakValid(prosedur3)) {
                JOptionPane.showMessageDialog(null, "Prosedur Sekunder 3 tidak boleh kosong atau '-'!");
    ...
    private void BtnDokter21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter21ActionPerformed
        ...
        inputresep.isCek();
        inputresep.setNoRm(TNoRw.getText(), TNoRM.getText(), TPasien.getText(), "-", dateformat2.format(new Date()).toString(), Sequel.cariIsi("select current_time()"));
        inputresep.tampil();
    ...
    private void BtnDokter22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter22ActionPerformed
        String edukasi
                = "1)Teredukasi tentang perawatan pasien di rumah sesuai kondisi penyakit\n"
                + "2)Teredukasi tentang jadwal kontrol/periksa ulang ke fasilitas kesehatan\n"
                + "3)Teredukasi tentang rujukan ke fasilitas kesehatan lain bila diperlukan";

        // Jika TextArea sudah ada isi, tambahkan di bawahnya
        if (!Edukasi.getText().trim().isEmpty()) {
            Edukasi.append("\n\n" + edukasi);
        } else {
